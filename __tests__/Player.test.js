...
test('gets inventory from player, or returns false/empty', () => {
    const player = new Player('Dave');
...
test('checks to see if a player is alive', () => {
    const player = new Player('Dave');
...
test('subtracting from players health', () => {
    const player = new Player('Dave');
...
test('gets player attack value', () => {
    ...
    console.log(`${player.strength} is the players strength`);
});
